...
e1 = open("/Users/tommypan/Desktop/txt-COVID-19WithSummary.txt",'a')
e2 = open("/Users/tommypan/Desktop/txt-COVID-19WithoutSummary.txt",'a')
f = open("/Users/tommypan/Desktop/CNKI-COVID-19.txt")
for line in f:
	if len(line) == 1:
		if temp != "":
			data.append(temp)
